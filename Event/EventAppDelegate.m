...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    EventsViewController *rootController = [[EventsViewController alloc] init];
    rootController.navigationController = self.navigationController;
    rootController.navigationItem.title = @"Events";
